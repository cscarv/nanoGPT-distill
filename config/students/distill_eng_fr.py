...
out_dir = 'checkpoints/students/distill_eng_fr' # name of the output directory
...
wandb_project = 'multi-teacher-distillation'
wandb_run_name = 'english-french-distilled-same-arch-as-teachers'
